...
public interface IndustryClient {
    ...
    default IndustryDto getIndustryIdFallback(Long id, Throwable exception) {
        System.out.println("Method getIndustryId, with args: " + id
                + ", failed with exception: " + exception + " message: " + exception.getMessage());
        return null;
    }
