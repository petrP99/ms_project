package com.petr.experience_service.kafka.producer;
...
public class ProducerKafkaConfiguration {
    ...
    private final static String TOPIC_NAME = "industry-topic";
    ...
    public Map<String, Object> producerConfiguration() {
        ...
        configuration.put(ProducerConfig.VALUE_SERIALIZER_CLASS_CONFIG, LongDeserializer.class);
